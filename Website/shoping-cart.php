...
if(isset($_POST['addCart'])){
	if(isset($_SESSION['finalCart'])){
		...
		$_SESSION['finalCart'][$count]=array("p_id"=>$_POST['p_id'],"p_name"=>$_POST['p_name'],"p_price"=>$_POST['p_price'],
		"p_des"=>$_POST['p_des'],"p_qty"=>$_POST['num-product'],"p_image"=>$_POST['p_image']);
		echo "<script>alert('cart added successfully')</script>";
		}

	}
	else{
		$_SESSION['finalCart'][0]=array("p_id"=>$_POST['p_id'],"p_name"=>$_POST['p_name'],"p_price"=>$_POST['p_price'],
		"p_des"=>$_POST['p_des'],"p_qty"=>$_POST['num-product'],"p_image"=>$_POST['p_image']);
		echo "<script>alert('cart added successfully')</script>";
	}
}
