                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="addCategory.php" class="dropdown-item">addCategory</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="addProduct.php" class="dropdown-item">addProduct</a>
                            <a href="viewProduct.php" class="dropdown-item">Product view</a>
                        </div>
                    </div>
